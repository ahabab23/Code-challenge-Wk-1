...
function nssfCalc() {
    ...
    if (basicSalary > 1000 && basicSalary <= 7000) {
        ...
        nssf = 420 + 0.06 * (basicSalary - 7000)
...
function payeeCalc() {
    ...
    if (taxablePay === 24001) {
        ...
        payee = 2400 + 0.25 * (taxablePay - 24001) - personalRelief - insuranceRelief
    } else if (taxablePay > 32333) {
        payee = 2400 + 0.25 * (32333 - 24000) + 0.3 * (taxablePay - 32333) - personalRelief - insuranceRelief
    } else {
        payee = 0
    }
...
function calc() {
    ...
    <tr><td> <h2>Gross Pay</h2></td>
        <td><h2 class='digits'>${basicSalary.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>
    <tr>
        <td><h2>Contribution Benefit</h2></td>
        <td><h2 class='digits'>${benefits.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>
    <tr>
        <td> <h2>NHIF Deductions</h2></td>
        <td><h2 class='digits'>${nhif.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>

    <tr>
        <td> <h2>NSSF Deductions</h2></td>
        <td><h2 class='digits'>${nssf.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>

    <tr>
        <td> <h2>Insurance Relief</h2></td>
        <td><h2 class='digits'>${insuranceRelief.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>

    <tr>
    <td> <h2>Personal Relief</h2></td>
    <td><h2 class='digits'>${personalRelief.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
     </tr>


    <tr>
        <td><h2>Payee</h2></td>
        <td><h2 class='digits'>${payee.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>
    <tr>
        <td><h2>Net salary</h2></td>
        <td><h2 class='digits'>${netPay.toLocaleString('en-US', { minimumFractionDigits: 1 })}</h2></td>
    </tr>
    </table>`
